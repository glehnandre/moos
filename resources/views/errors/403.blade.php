...
<div class="row">
   ...
   <div class="error-container" >
    <div class="error-main">
      ...
      <div class="error-description" > Parce que você se perdeu! </div>
      <div class="error-description-mini"> Você não tem permissão para acessar essa página. </div>
      <br>
      <div class="row">
...
<div id="footer">
  <div class="error-container">
    ...
    <br>
    <div class="copyright"> Todos dos direitos reservados. Moo$, 2018 </div>
  </div>
</div>
<!-- END CONTAINER -->
