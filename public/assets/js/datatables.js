...
function fnFormatDetails ( oTable, nTr )
{
    ...
    sOut += '<tr><td>Cartão:</td><td>'+aData[1]+'</td></tr>';
    sOut += '<tr><td>Nome completo:</td><td>'+aData[2]+'</td></tr>';
    sOut += '<tr><td>CPF:</td><td>'+aData[3]+'</td></tr>';
    sOut += '<tr><td>Tipo da transação:</td><td>'+aData[4]+'</td></tr>';
    sOut += '<tr><td>Bandeira do Cartao de crédito:</td><td>'+aData[5]+'</td></tr>';
    sOut += '<tr><td>Saldo atual do cartão:</td><td>'+aData[6]+'</td></tr>';
    sOut += '<tr><td>Valor creditado/debitado:</td><td>'+aData[7]+'</td></tr>';
    sOut += '</table>';
